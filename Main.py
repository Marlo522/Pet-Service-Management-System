...
class PetServiceManagementSystem:
    ...
    def load_patient_dashboard(self, username):
        ...
        tk.Button(self.frame, text="Grooming Services", font=("Arial", 12, "bold")).pack(pady=5)
    ...
    # Define the treeview for the table
            ...
            for pet in pets:
                ...
                # Load the pet picture
                    if pet["picture_path"]:
                        ...
                        pet_table.insert("", tk.END, values=(
                        pet["name"],
                        pet["species"],
                        pet["age"],
                        "Image Displayed"
